    ...
    <>
      <div className="w-64 h-screen bg-indigo-50/30 border-r border-indigo-100 flex flex-col justify-between py-6 px-4">
        <div>
          ...
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg py-2.5 px-4 flex items-center justify-center gap-2 font-medium mb-8 transition-colors cursor-pointer shadow-sm shadow-indigo-200"
          >
        ...
        <div className="mt-8 border-t border-indigo-100 pt-4">
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 w-full text-slate-600 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg text-sm font-medium transition-colors cursor-pointer"
          >
      ...
      <ReportItemModal
        ...
        onItemCreated={() => {
          ...
          // navigate or reload current page if needed
          if (location.pathname === "/found-items" || location.pathname === "/lost-items" || location.pathname === "/overview") {
